...
<div
	class="mx-auto max-w-3xl md:mt-20"
	transition:scale={{ opacity: 0, start: 0.98 }}
>
	<div
		class="flex max-w-xl flex-col gap-8 rounded-xl p-6 text-center leading-relaxed"
	>
		...
		<p>
			...
			<code class="rounded-md bg-muted px-1 py-0.5">useChat</code> hook on the client
