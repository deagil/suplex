<script lang="ts">
	...
	import PreviewAttachment from '../copilot/preview-attachment.svelte';
	import { Markdown } from '../markdown';
	import MessageReasoning from '../copilot/message-reasoning.svelte';
	...
	let {
		...
		readonly,
		loading,
	}: { message: UIMessage; readonly: boolean; loading: boolean } = $props();
